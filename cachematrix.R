...
## then it will look the value up in the cache (the list), otherwise it will calculate it using the
## solve function and set the value in the cache via the setinverse function.
